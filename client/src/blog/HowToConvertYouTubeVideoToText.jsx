  ...
  return (
    <div className="min-h-screen bg-[#f9fafb] text-[#1a1a2e] leading-[1.8] font-sans">
      ...
      <article className="max-w-[780px] mx-auto my-[60px] px-6 pb-20">
        ...
        <div className="article-body">
          ...
          <div className="bg-[#f8fafc] border-l-4 border-indigo-500 rounded-r-[10px] py-4 px-5 my-5">
            ...
            <p className="m-0 text-[#334155]"><strong className="text-[#0f172a]">Open the tool</strong> — Go to <Link to="/" className="text-indigo-500 no-underline hover:underline">YouTubeToTranscript.io</Link> and paste the URL (see <Link to="/blog/how-to-get-youtube-transcript" className="text-indigo-500 no-underline hover:underline">how to get a YouTube transcript</Link>) into the input field.</p>
          </div>
          <div className="bg-[#f8fafc] border-l-4 border-indigo-500 rounded-r-[10px] py-4 px-5 my-5">
      ...
      <div className="max-w-[780px] mx-auto px-6">
        <RelatedArticles currentSlug="how-to-convert-youtube-video-to-text" />
      </div>
