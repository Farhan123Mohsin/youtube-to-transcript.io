  ...
  return (
    <div className="min-h-screen bg-[#f9fafb] text-[#1a1a2e] leading-[1.8] font-sans">
      ...
      <article className="max-w-[780px] mx-auto my-[60px] px-6 pb-20">
        ...
        <div className="article-body">
          ...
          <div className="bg-[#f8fafc] border-l-4 border-indigo-500 rounded-r-[10px] py-4 px-5 my-5">
            ...
            <p className="m-0 text-[#334155]"><strong className="text-[#0f172a]">Paste it into the tool</strong> — Open <Link to="/" className="text-indigo-500 no-underline hover:underline">YouTubeToTranscript.io</Link> and paste the URL (our <Link to="/blog/how-to-get-youtube-transcript" className="text-indigo-500 no-underline hover:underline">guide to getting a YouTube transcript</Link> has the full steps) into the input field on the homepage.</p>
          </div>
          <div className="bg-[#f8fafc] border-l-4 border-indigo-500 rounded-r-[10px] py-4 px-5 my-5">
      ...
      <div className="max-w-[780px] mx-auto px-6">
        <RelatedArticles currentSlug="youtube-transcript-with-timestamps" />
      </div>
